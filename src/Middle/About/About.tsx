...
const About = () => {
    ...
    return (
        <div className={cl.container}>
            <div className={[cl.info, !showRect && cl.show].join(' ')}>
                <h3 className='big bold grey'>Заказать суши в Москве</h3>
                ...
                <ul className={['mid', 'reg', 'grey', cl.list].join(' ')}>
                    <br/>
