    ...
    return (
        <header className={cl.header}>
            <div className={cl.contacts}>
                <h3 className={[cl.phone, 'mid', 'medium', 'black'].join(' ')}>Наш телефон</h3>
                <div>
                    <p className='mid medium orange'>+996 705 188 955</p>
                    <p className='mid medium orange'>+996 555 188 955</p>
                </div>
                <div className={cl.workingHours}>
                    ...
                    <p className={[cl.text, 'small', 'medium', 'grey'].join(' ')}>
                        работаем с <time dateTime="10:00">10:00</time> до <time dateTime="00:00">00:00</time>
                    </p>
                </div>
            </div>
            {!(location.pathname === '/take-order') &&
                <div className={cl.mainHeader}>
                    <div className={cl.city}>
                        ...
                        <p className='mid reg black'>Москва</p>
                    </div>
                    <nav className={cl.navigation}>
                        <Link className={[cl.link, 'link', 'mid', 'reg', 'black'].join(' ')} to='/reviews'>Отзывы</Link>
                        <Link className={[cl.link, 'link', 'mid', 'reg', 'black'].join(' ')} to='/take-order'>Доставка и
                            оплата</Link>
                    </nav>
